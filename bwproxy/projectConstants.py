...
STD_SET_ICON_POSITION: XY = (
    CARD_H - BORDER - SET_ICON_SIZE,
    STD_LAYOUT.BORDER.TYPE_LINE + (STD_LAYOUT.SIZE.TYPE_LINE - SET_ICON_SIZE) // 2,
)
STD_PTL_BOX: Box = (
...
SPLIT_SET_ICON_POSITION: Tuple[XY, XY] = tuple(
    (
        s - BORDER - SET_ICON_SIZE,
        SPLIT_LAYOUT.BORDER.TYPE_LINE
        + (SPLIT_LAYOUT.SIZE.TYPE_LINE - SET_ICON_SIZE) // 2,
    )
...
AFTERMATH_SET_ICON_POSITION: XY = (
    CARD_H - BORDER - SET_ICON_SIZE,
    AFTERMATH_LAYOUT.BORDER.TYPE_LINE
    + (AFTERMATH_LAYOUT.SIZE.TYPE_LINE - SET_ICON_SIZE) // 2
)
...
FLIP_SET_ICON_POSITION: XY = (
    CARD_H - BORDER - SET_ICON_SIZE,
    FLIP_LAYOUT.BORDER.TYPE_LINE
    + (FLIP_LAYOUT.SIZE.TYPE_LINE - SET_ICON_SIZE) // 2
)
FLIP_PTL_BOX: Box = (
    (
...
LAND_LAYOUT.BORDER.ILLUSTRATION = LAND_LAYOUT.BORDER.TITLE + LAND_LAYOUT.SIZE.TITLE
LAND_LAYOUT.BORDER.OTHER = CARD_V - LAND_LAYOUT.SIZE.OTHER
LAND_LAYOUT.BORDER.TYPE_LINE = LAND_LAYOUT.BORDER.OTHER - LAND_LAYOUT.SIZE.TYPE_LINE
LAND_LAYOUT.SIZE.ILLUSTRATION = LAND_LAYOUT.BORDER.TYPE_LINE - LAND_LAYOUT.BORDER.ILLUSTRATION
LAND_LAYOUT.FONT_MIDDLE.TYPE_LINE = (
    LAND_LAYOUT.BORDER.TYPE_LINE + LAND_LAYOUT.SIZE.TYPE_LINE // 2 - BORDER // 2
)
LAND_SET_ICON_POSITION: XY = (
    CARD_H - BORDER - SET_ICON_SIZE,
    LAND_LAYOUT.BORDER.TYPE_LINE + (STD_LAYOUT.SIZE.TYPE_LINE - SET_ICON_SIZE) // 2,
)
LAND_MANA_SYMBOL_SIZE = 600
